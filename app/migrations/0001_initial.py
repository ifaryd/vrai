# Generated by Django 2.2.14 on 2021-09-28 10:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transmission', models.CharField(choices=[('AUTOMATIQUE', 'AUTOMATIQUE'), ('MANUEL', 'MANUEL'), ('HYBRIDE', 'HYBRIDE')], max_length=300)),
                ('carburant', models.CharField(choices=[('ESSENCE', 'ESSENCE'), ('GASOIL', 'GASOIL')], max_length=300)),
